...
import { NewChat } from "@/components/chats/components/new-chat";
import { type ChatUser, type Convo } from "@/components/chats/data/chat-types";
// Fake Data
import convo from "@/components/chats/data/convo.json";
...
export default function Chats() {
  ...
  const filteredChatList = convo.conversations.filter(({ fullName }) =>
  ...
  const users = convo.conversations.map(({ messages, ...user }) => user);
